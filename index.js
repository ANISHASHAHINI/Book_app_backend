...
//middleware ->make connection to frontend site
app.use(cors());
...
async function run() {
  try {
    ...
    app.patch("/books/:id",async(req,res) =>{
      ...
      const oprtions = { upsert: true };
      //update 
      const result = await booksCollection.updateOne(filter,updateDoc,oprtions);
      res.send(result);
    })
